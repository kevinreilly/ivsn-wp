...
function responsive_read_more() {
    return '<div class="read-more"><a href="' . get_permalink() . '">' . __('Read more &#8250;', 'responsive') . '</a></div>';
}
...
function responsive_breadcrumb_lists() {
    ...
    function responsive_widgets_init() {
		...
		register_sidebar(array(
            'name' => __('Left News Sidebar', 'responsive'),
            'description' => __('Area 12 - sidebar-leftnews.php', 'responsive'),
            'id' => 'leftnews-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		...
		register_sidebar(array(
            'name' => __('Left Volunteer Sidebar', 'responsive'),
            'description' => __('Area 13 - sidebar-leftvol.php', 'responsive'),
            'id' => 'leftvol-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		...
		register_sidebar(array(
            'name' => __('Left Donate Sidebar', 'responsive'),
            'description' => __('Area 14 - sidebar-leftdon.php', 'responsive'),
            'id' => 'leftdon-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		...
		register_sidebar(array(
            'name' => __('Left Get Help Sidebar', 'responsive'),
            'description' => __('Area 15 - sidebar-lefthelp.php', 'responsive'),
            'id' => 'lefthelp-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
		...
		register_sidebar(array(
            'name' => __('Left About Sidebar', 'responsive'),
            'description' => __('Area 16 - sidebar-leftabout.php', 'responsive'),
            'id' => 'leftabout-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
            'after_widget' => '</div>'
		...
		register_sidebar(array(
            'name' => __('Left Connect Sidebar', 'responsive'),
            'description' => __('Area 17 - sidebar-leftconnect.php', 'responsive'),
            'id' => 'leftconnect-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
            'after_widget' => '</div>'
		...
		register_sidebar(array(
            'name' => __('eNews Signup', 'responsive'),
            'description' => __('Area 18 - sidebar-enews.php', 'responsive'),
            'id' => 'enews-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
...
function menuDirect() {
	echo '<a class="menu-direct" href="#widgets">Menu &raquo;</a>';
}
