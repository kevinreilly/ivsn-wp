...
?>  
    ...
    <div id="widgets" class="home-widgets">
        <div class="grid col-300" style="border-top:15px solid #ec9123;background: white url(http://ivsn.wpengine.com/wp-content/themes/responsive/core/images/orange.png);background-repeat: repeat-x;">
        ...
        <div class="grid col-300" style="border-top:15px solid #751b53;margin-left:-1%;box-shadow:-5px 0px 15px -6px #666;background-image:url(http://ivsn.wpengine.com/wp-content/themes/responsive/core/images/purple.png);background-repeat: repeat-x;">
        ...
        <div class="grid col-300 fit" style="border-top:15px solid #9ebb35;margin-left:-1% !important;box-shadow:-5px 0px 15px -6px #666;background-image:url(http://ivsn.wpengine.com/wp-content/themes/responsive/core/images/green.png);background-repeat: repeat-x;">
        <?php responsive_widgets(); // above widgets hook ?>
